...
static int audio_thread(void *arg)
{
    ...
    while(!ffp->is->initialized_demuxer)
        SDL_Delay(5);

    if (ffp->is->extradata_diff)
        return 0;
