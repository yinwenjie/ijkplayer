...
dependencies {
    ...
    compile 'tv.danmaku.ijk.media:ijkplayer-armv7a:0.8.9'

    # Other ABIs: optional
    compile 'tv.danmaku.ijk.media:ijkplayer-armv5:0.8.9'
    compile 'tv.danmaku.ijk.media:ijkplayer-arm64:0.8.9'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86:0.8.9'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86_64:0.8.9'

    # ExoPlayer as IMediaPlayer: optional, experimental
    compile 'tv.danmaku.ijk.media:ijkplayer-exo:0.8.9'
}
```
- iOS
 - in coming...
