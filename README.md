...
dependencies {
    ...
    compile 'tv.danmaku.ijk.media:ijkplayer-java:0.8.7-test7'
    compile 'tv.danmaku.ijk.media:ijkplayer-armv7a:0.8.7-test7'

    # Other ABIs: optional
    compile 'tv.danmaku.ijk.media:ijkplayer-armv5:0.8.7-test7'
    compile 'tv.danmaku.ijk.media:ijkplayer-arm64:0.8.7-test7'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86:0.8.7-test7'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86_64:0.8.7-test7'

    # ExoPlayer as IMediaPlayer: optional, experimental
    compile 'tv.danmaku.ijk.media:ijkplayer-exo:0.8.7-test7'
}
```
- iOS
 - in coming...
...
git checkout -B latest k0.8.7-test7
