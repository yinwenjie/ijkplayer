...
dependencies {
    ...
    compile 'tv.danmaku.ijk.media:ijkplayer-java:0.8.9.2-service'
    compile 'tv.danmaku.ijk.media:ijkplayer-armv7a:0.8.9.2-service'

    # Other ABIs: optional
    compile 'tv.danmaku.ijk.media:ijkplayer-armv5:0.8.9.2-service'
    compile 'tv.danmaku.ijk.media:ijkplayer-arm64:0.8.9.2-service'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86:0.8.9.2-service'
    compile 'tv.danmaku.ijk.media:ijkplayer-x86_64:0.8.9.2-service'

    # ExoPlayer as IMediaPlayer: optional, experimental
    compile 'tv.danmaku.ijk.media:ijkplayer-exo:0.8.9.2-service'
}
```
- iOS
 - in coming...
...
git checkout -B latest k0.8.9.2-service
